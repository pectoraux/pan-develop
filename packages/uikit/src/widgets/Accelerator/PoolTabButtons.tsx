...
import { ButtonMenu, ButtonMenuItem, Toggle, Text, NotificationDot, LinkExternal, NextLinkFromReactRouter } from "../../components";
...
const PoolTabButtons = ({
  ...
  const isExact = router.pathname.includes('bounties')
  ...
  const liveOrFinishedSwitch = (
    <Wrapper>
      <ButtonMenu activeIndex={!isExact ? 0 : 1} scale="sm" variant="subtle">
        <ButtonMenuItem as={NextLinkFromReactRouter} to="/accelerator" replace>
          {t('Pitches')}
        </ButtonMenuItem>
        <ButtonMenuItem as={NextLinkFromReactRouter} to="/accelerator/bounties" replace>
          {t('Bounties')}
        </ButtonMenuItem>
      </ButtonMenu>
    </Wrapper>
