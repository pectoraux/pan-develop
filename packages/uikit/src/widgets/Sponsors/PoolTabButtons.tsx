...
const PoolTabButtons = ({
  ...
  const isExact = router.pathname.includes('sponsors/bounties')
  ...
  const liveOrFinishedSwitch = (
    <Wrapper>
      <ButtonMenu activeIndex={isExact ? 1 : 0} scale="sm" variant="subtle">
        <ButtonMenuItem as={NextLinkFromReactRouter} to="/sponsors" replace>
          {t('Sponsors')}
        </ButtonMenuItem>
        <ButtonMenuItem as={NextLinkFromReactRouter} to="/sponsors/bounties/admin" replace>
          {t('Bounties')}
        </ButtonMenuItem>
      </ButtonMenu>
    </Wrapper>
