...
import { ButtonMenu, ButtonMenuItem, Toggle, Text, NextLinkFromReactRouter } from "../../components";
  ...
  const liveOrFinishedSwitch = (
    <Wrapper>
      <ButtonMenu activeIndex={!isExact ? 0 : 1} scale="sm" variant="subtle">
        ...
        <ButtonMenuItem as={NextLinkFromReactRouter} to="/businesses/bounties" replace>
          {t('Bounties')}
        </ButtonMenuItem>
      </ButtonMenu>
    </Wrapper>
