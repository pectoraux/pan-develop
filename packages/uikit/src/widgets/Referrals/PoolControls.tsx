...
export function PoolControls<T>({
  ...
  chosenPools = useMemo(() => {
    ...
    .filter((p: any) => favoritesOnly ? watchlistTokens.includes(`referrals-${p?.id}`) : true)
      ...
      <PoolControlsView>
        ...
        <FilterContainer>
          ...
          <LabelWrapper style={{ marginLeft: 16 }}>
            ...
            <SearchInput initialValue={searchQuery} onChange={handleChangeSearchQuery} placeholder={t("Search Referrers")} />
          </LabelWrapper>
        </FilterContainer>
      </PoolControlsView>
