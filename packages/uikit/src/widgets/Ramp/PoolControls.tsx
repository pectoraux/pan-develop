...
export function PoolControls<T>({
  ...
  const [finishedPools, openPools] = useMemo(() => partition(pools && pools[0]?.accounts, (acct) => !acct.isOverCollateralised), [pools]);
      ...
      <PoolControlsView>
        ...
        <FilterContainer>
          ...
          <LabelWrapper style={{ marginLeft: 16 }}>
            ...
            <SearchInput initialValue={searchQuery} onChange={handleChangeSearchQuery} placeholder={t("Search Tokens")} />
          </LabelWrapper>
        </FilterContainer>
      </PoolControlsView>
