...
export const fetchBillSgAsync = ({ fromBill }) => async (dispatch) => {
  try {
...
export const fetchBillsAsync = ({ fromBill }) => async (dispatch) => {
...
export const fetchBillsUserDataAsync = createAsyncThunk<
...
export const PoolsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(
      fetchBillsUserDataAsync.fulfilled,
      (
        state,
    ...
    builder.addCase(fetchBillsUserDataAsync.rejected, (state, action) => {
