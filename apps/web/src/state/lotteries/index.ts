...
export const fetchLotteriesSgAsync = ({ fromLottery }) => async (dispatch) => {
  try {
...
export const fetchLotteriesAsync = ({ fromLottery }) => async (dispatch) => {
...
export const fetchLotteriesUserDataAsync = createAsyncThunk<
...
export const PoolsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(
      fetchLotteriesUserDataAsync.fulfilled,
      (
        state,
    ...
    builder.addCase(fetchLotteriesUserDataAsync.rejected, (state, action) => {
