...
export const fetchBettingSgAsync = ({ fromBetting }) => async (dispatch) => {
  try {
...
export const fetchBettingsAsync = ({ fromBetting }) => async (dispatch) => {
...
export const fetchBettingsUserDataAsync = createAsyncThunk<
...
export const PoolsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(
      fetchBettingsUserDataAsync.fulfilled,
      (
        state,
    ...
    builder.addCase(fetchBettingsUserDataAsync.rejected, (state, action) => {
