...
//   const will  = useMemo(() => router.query.will, [router.query.will],) 

//   useSlowRefreshEffect (() => dispatch(fetchWillAsync(will)), [dispatch],)
// }
  ...
  useSlowRefreshEffect(
    () => {
      const fetchPoolsDataWithFarms = async () => {
        await dispatch(fetchWillAsync(will))
      }
...
export const fetchPoolsDataWithFarms = async (will, dispatch) => {
  if (will) {
    batch(() => {
      dispatch(fetchWillAsync(will))
    })
  }
}
