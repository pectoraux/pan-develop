...
export const fetchArpSgAsync = ({ fromArp }) => async (dispatch) => {
  try {
...
export const fetchArpsAsync = ({ fromArp }) => async (dispatch) => {
...
export const fetchArpsUserDataAsync = createAsyncThunk<
...
export const PoolsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(
      fetchArpsUserDataAsync.fulfilled,
      (
        state,
    ...
    builder.addCase(fetchArpsUserDataAsync.rejected, (state, action) => {
