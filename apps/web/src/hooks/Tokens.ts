...
import { Currency, ERC20Token, ChainId, Price } from '@pancakeswap/sdk'
...
export function useWorkspaceCurrency(
  ...
  const mainToSecondaryCurrencyFactor = useBNBBusdPrice()
  const priceInSecondaryCurrency = multiplyPriceByAmount(
