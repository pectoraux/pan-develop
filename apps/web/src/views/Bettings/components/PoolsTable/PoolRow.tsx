...
const PoolRow: React.FC<any> = ({
  ...
  return (
    ...
    >
      <NameCell pool={pool} />
      <TotalUsersCell pool={pool} account={account} labelText={t("Total Events")} />
      <VotesCell pool={currAccount} />
      <TotalValueCell labelText={t('Ticket Size')} value={currAccount?.ticketSize} />
      {/* <TotalValueCell labelText={t('Amount Due')} pool={pool} /> */}
