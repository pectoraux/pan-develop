  ...
  return (
    ...
    <GreyedOutContainer>
        <StyledItemRow>
          ...
          <ButtonMenu scale="xs" variant='subtle' activeIndex={state.fungible} onItemClick={handleRawValueChange('fungible')}>
    ...
    <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
      ...
      <Box>
        <Text small color="textSubtle">
          {t('The burns your tokens for payment credits in the lottery. Please read the documentation for more information.')}
        </Text>
      </Box>
    </Grid>
      <Divider />
