    ...
    <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
      ...
      <Box>
        <Text small color="textSubtle">
          {t('The removes the specified amount of the specified token from your will contract. Please read the documentation for more information on this parameter')}
        </Text>
      </Box>
    </Grid>
      <Divider />
