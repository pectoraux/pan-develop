  ...
  return (
    ...
    <GreyedOutContainer >
      <Flex alignItems="center" justifyContent="center">
          <ButtonMenu scale="xs" variant='subtle' activeIndex={state.admins ? 1 : 0} onItemClick={handleRawValueChange('admins')}>
            <ButtonMenuItem >{t("OG Admin")}</ButtonMenuItem>
            <ButtonMenuItem >{t("Admins")}</ButtonMenuItem>
          </ButtonMenu> 
        </Flex>
    </GreyedOutContainer>
    <GreyedOutContainer>
