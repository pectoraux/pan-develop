...
import { useVaFactoryContract, useValuepoolFactory, useValuepoolHelperContract } from 'hooks/useContract'
    ...
    > 
      <GreyedOutContainer>
        ...
        <Input
          ...
          name='name'
          value={state.name}
          placeholder={t('input contract name')}
          onChange={handleChange}
        />
      </GreyedOutContainer>
      <GreyedOutContainer>
        <Text fontSize="12px" color="secondary" textTransform="uppercase" bold>
          {t('%titleName% description', { titleName })}
        </Text>
        <Input
          type="text"
          scale="sm"
          ...
          placeholder={t('input your description')}
          onChange={handleChange}
        />
      </GreyedOutContainer>
      <GreyedOutContainer>
