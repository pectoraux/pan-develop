...
// import { useUserBettingChainlinkChartDisclaimerShow } from 'state/user/hooks'
...
const ChartDisclaimer: FC<React.PropsWithChildren<InjectedModalProps>> = ({ onDismiss }) => {
  // const [showDisclaimer, setShowDisclaimer] = useUserBettingChainlinkChartDisclaimerShow()
    ...
    <ModalContainer $minWidth="320px">
      <ModalBody p="24px" maxWidth="400px">
        <Flex justifyContent="center" mb="32px">
          <Image src="/images/bettings/chartwarning2.svg" width={190} height={118} />
        </Flex>
        <Heading as="h3" size="sm">
          {t('Currently showing charts from Chainlink oracle')}
        </Heading>
        <Text color="textSubtle" fontSize="14px" my="24px">
          {t('The price you see come directly from the Chainlink oracle, which powers the Betting game.')}
        </Text>
        <Ul>
