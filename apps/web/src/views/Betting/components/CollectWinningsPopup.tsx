...
// import { getBetHistory } from 'state/bettings/helpers'
...
const CollectWinningsPopup = () => {
  ...
  // const bettingStatus = useGetPredictionsStatus()
  ...
  //     isCancelled = true
  //   }
  // }, [account, timer, bettingStatus, setIsOpen, isHistoryPaneOpen, api, token.symbol])
