...
> = ({ ticket, betting, duplicateWith, updateTicket, disabled }) => {
  ...
  // const digitRefs = []
  // for (let count = 1; count < ticketSize; count++) {
  //   digitRefs.push(digit6)
  // }
  // console.log("digitRefs===============>", digitRefs, digitRefs2)
