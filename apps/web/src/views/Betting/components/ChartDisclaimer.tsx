...
// import { useUserBettingChartDisclaimerShow } from 'state/user/hooks'
...
const ChartDisclaimer: React.FC<React.PropsWithChildren<InjectedModalProps>> = ({ onDismiss }) => {
  // const [showDisclaimer, setShowDisclaimer] = useUserBettingChartDisclaimerShow()
    ...
    <ModalContainer $minWidth="320px">
      <ModalBody p="24px" maxWidth="400px">
        <Flex justifyContent="center" mb="32px">
          <Image src="/images/bettings/chartwarning.svg" width={190} height={118} />
        </Flex>
        ...
        <LinkExternal
          href="https://docs.pancakeswap.finance/products/betting/betting-faq#what-are-you-using-for-your-price-feed"
          external
          mb="24px"
        >
          {t('Learn More')}
