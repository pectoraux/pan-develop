...
// import { setChartPaneState, setHistoryPaneState } from 'state/bettings'
...
const MobileMenu = () => {
  ...
  const isChartOpen = true
  // const status = useGetBettingsStatus()
  ...
  return (
    <StyledMobileMenu>
      <ButtonNav>
        ...
        // disabled={status !== BettingStatus.LIVE}
        >
