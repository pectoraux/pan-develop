...
const SetPositionCard: React.FC<any> = ({
  position,
  togglePosition,
  epoch,
  onBack,
  ...
  // const { address: bettingsAddress, token } = useConfig()
  // const bettingsContract = useBettingContract(bettingsAddress, token.symbol)
  // const useTokenBalance = useMemo(() => {
  //   return TOKEN_BALANCE_CONFIG[token.symbol]
  // }, [token.symbol])

  // const { isVaultApproved, setLastUpdated } = useCakeApprovalStatus(token.symbol === 'CAKE' ? bettingsAddress : null)
  // const { handleApprove, pendingTx } = useCakeApprove(
  //   setLastUpdated,
  //   bettingsAddress,
  //   t('You can now start betting'),
  // )

  // // BNB betting doesn't need approval
  // const doesCakeApproveBetting = token.symbol === 'BNB' || isVaultApproved
  ...
  //     return callWithGasPrice(bettingsContract, betMethod, args, callOptions)
  //   })
  //   if (receipt?.status) {
