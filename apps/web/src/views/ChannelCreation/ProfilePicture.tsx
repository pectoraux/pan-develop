...
const ProfilePicture: React.FC = () => {
      ...
      try {
        ...
        if (nftsByCollection.length > 0) {
          ...
          setUserProfileCreationNfts(
            userNfts.filter((nft) => collectionRoles[nftsByCollection.indexOf(nft.collectionAddress)]),
          )
        }
      } catch (e) {
        console.error(e)
  ...
  }, [userNfts, profileContract, isUserNftLoading])
