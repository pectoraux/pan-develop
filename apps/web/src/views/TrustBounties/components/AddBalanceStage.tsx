...
const SetPriceStage: React.FC<any> = ({
  ...
  return (
    ...
    <GreyedOutContainer style={{ paddingTop:"50px" }}>
        ...
        <ButtonMenu scale="xs" variant='subtle' activeIndex={state.nativeCoin} onItemClick={handleRawValueChange('nativeCoin')}>
    ...
    <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
      ...
      <Box>
        <Text small color="textSubtle">
          {t('The will add a new balance to your bounty. Please read the documentation for more information on each parameter')}
        </Text>
      </Box>
    </Grid>
      <Divider />
