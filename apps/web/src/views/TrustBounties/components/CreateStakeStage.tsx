      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          <Text small color="textSubtle">
            {t('The will create a stake in the stake market and enable you to start receiving applications for your stake.')}
          </Text>
          <Text small color="textSubtle">
            {t('Go through the applications and accept the most convenient for you.')}
          </Text>
        </Box>
      </Grid>
      <Divider />
