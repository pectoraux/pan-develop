  ...
  return (
    ...
    <GreyedOutContainer>
      ...
      <Input
        ...
        placeholder={t('input your object\'s name')}
    ...
    <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
      ...
      <Box>
        <Text small color="textSubtle">
          {t('The will burn the specified object from your gaming ticket. Please read the documentation for more information on this parameter')}
        </Text>
      </Box>
    </Grid>
      <Divider />
