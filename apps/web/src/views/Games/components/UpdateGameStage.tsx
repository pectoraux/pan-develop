  ...
  return (
    ...
    <GreyedOutContainer>
      <StyledItemRow>
          ...
          <ButtonMenu scale="xs" variant='subtle' activeIndex={state.claimable ? 1 : 0} onItemClick={handleRawValueChange('claimable')}>
      ...
      <Box>
        <Text small color="textSubtle">
          {t('The will update parameters of the game. Please read the documentation for more information on each parameter')}
        </Text>
      </Box>
    </Grid>
      <Divider />
