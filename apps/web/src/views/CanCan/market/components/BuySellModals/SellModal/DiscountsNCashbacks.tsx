...
const DiscountsNCashbacks: React.FC<any> = ({
  ...
  const { discountStatus, discountStart, cashNotCredit, checkIdentityCode, checkItemOnly, cashbackStatus, cashbackStart, discountNumbers, discountCost, cashbackNumbers, cashbackCost } = state
