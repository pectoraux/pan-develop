...
export const ListCollectionFilter: React.FC<any> = ({
  ...
  const { addActivityCollectionFilters, removeActivityCollectionFilters, removeAllActivityFilters } =
    useNftStorage()
  ...
  const handleClearFilter = () => {
    ...
    removeAllActivityFilters(address)
  }
  console.log("filteredCollections===============>", products, filteredCollections, nftActivityFilters)
  ...
  const handleItemClick = (evt: ChangeEvent<HTMLInputElement>, product) => {
    if (evt.target.checked) {
      addActivityCollectionFilters({ address, collection: product })
    } else {
      removeActivityCollectionFilters({ address, collection: product })
    }
  }
