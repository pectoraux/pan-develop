...
import { BunnyPlaceholderIcon, Spinner, LinkExternal, Input, Link, AutoRenewIcon, Button, Flex, Grid, Text, useModal, Dots } from '@pancakeswap/uikit'
...
const Paywall: React.FC<any> = ({ collection, paywall }) => {
  ...
  const { ongoingSubscription, status } = useGetSubscriptionStatus(paywallARP?.paywallAddress ?? '', account ?? '', nfticketId ?? '0', paywall?.tokenId ?? '')
