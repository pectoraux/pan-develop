...
const PoolAllocations = () => {
  const { t } = useTranslation()
  const { lotteryData: { rewardsBreakdown } } = useLottery()
  return (
...
const HowToPlay: React.FC<any> = () => {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      subtitle: t('Some lotteries can be drawned after a certain prize pot goal is reached or after a time specified by the owner has passed.'),
    },
    {
