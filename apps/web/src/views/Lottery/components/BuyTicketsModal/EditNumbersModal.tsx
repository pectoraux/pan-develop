...
const EditNumbersModal: React.FC<any> = ({ totalCost, token, updateTicket, randomize, tickets, allComplete, onConfirm, isConfirming, onDismiss }) => {
    ...
    >
      <ScrollableContainer>
        <Flex justifyContent="space-between" mb="16px">
          ...
          <Text>~{totalCost} {token?.symbol ?? ''}</Text>
        </Flex>
