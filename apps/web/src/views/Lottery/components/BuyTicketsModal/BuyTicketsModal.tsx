...
const BuyTicketsModal: React.FC<any> = ({ onDismiss }) => {
  ...
  // const tokenData = [
  //   {
  //     amountCollected: new BigNumber('10000000000000000000'),
  //     token: new Token(
  //       56,
  ...
  //   },
  //   {
  //     amountCollected: new BigNumber('100000000000000000000'),
  //     token: new Token(
  //       56,
  //       "0xbE04187288D198ed6F0d90eCAAca0fE42Dd434Fe",
  //       18,
  ...
  const { isApproving, isApproved, isConfirmed, isConfirming, handleApprove, handleConfirm } =
    ...
    onConfirm: () => {
        ...
        .catch((err) => console.log("buyWithContract==============>", err))
      },
    ...
    <StyledModal title={t('Buy Tickets')} onDismiss={onDismiss} headerBackground={theme.colors.gradientCardHeader}>
      ...
      <Flex flexDirection="column">
        <Flex mb="8px" justifyContent="space-between">
          ...
          <Text color="textSubtle" fontSize="14px">
            {priceTicketInCake && getFullDisplayBalance(priceTicketInCake.times(ticketsToBuy || 0))} {currToken?.token?.symbol ?? ''}
          </Text>
        </Flex>
        <Flex mb="8px" justifyContent="space-between">
          <Flex>
