    ...
    <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
      ...
      <Box>
        <Text small color="textSubtle">
          {t("The will update the code information for the specified tokens in the specified world. Please read the documentation for more details.")}
        </Text>
      </Box>
    </Grid>
      <Divider />
