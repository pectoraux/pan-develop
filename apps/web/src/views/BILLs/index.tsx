...
const Pools: React.FC<any> = () => {
  ...
  const { pools, userDataLoaded: billsLoaded } = usePoolsWithFilterSelector()
  ...
  const userDataLoaded = isBounties ? bountiesLoaded : billsLoaded
        ...
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            <Heading as="h1" scale="xxl" color="secondary" mb="24px">
              {isBounties ? t('Trust Bounties') : t('BILL Contracts')}
            </Heading>
            ...
            <Heading scale="md" color="text">
              {t('Browse between different bills and apply for an account in one offering the services you are looking for.')}
            </Heading>
            <Flex>
