...
const Pools: React.FC<any> = () => {
  ...
  const [onPresentAdminSettings] = useModal(<CreateGaugeModal variant='admin' location='fromAuditor' currency={currency} pool={ogAuditor} />,)
          ...
          {({ chosenPools, viewMode, stakedOnly, normalizedUrlSearch }) => (
            <>
              ...
              {viewMode === ViewMode.CARD ? (
                ...
                <PoolsTable urlSearch={normalizedUrlSearch} ogAuditor={ogAuditor} pools={chosenPools} account={account} />
              )}
              <Image
                mx="auto"
                mt="12px"
