  ...
  const { isApproving, isApproved, isConfirming, handleApprove, handleConfirm } = useApproveConfirmTransaction({
    ...
    onConfirm: () => {
      ...
      if (stage === LockStage.CONFIRM_DISTRIBUTE) {
        ...
        return callWithGasPrice(referralVoterContract, 'claimRewards', [[pool.gauge], [[currency.address]]])
      ...
      if (stage === LockStage.CONFIRM_WITHDRAW) {
        ...
        return callWithGasPrice(referralVoterContract, 'claimBribes', [[pool.bribe], [[currBribeAddress]]])
      ...
      if (stage === LockStage.CONFIRM_DELETE) {
        return callWithGasPrice(referralVoterContract, 'deactivateGauge', [])
