    ...
    <GreyedOutContainer>
      ...
      <GreyedOutContainer>
        ...
        <Input
          ...
          placeholder={t('input product id address')}
          onChange={handleChange}
        />
      </GreyedOutContainer>
      <GreyedOutContainer>
      ...
      <StyledItemRow>
          ...
          <ButtonMenu scale="xs" variant='subtle' activeIndex={state.isPaywall} onItemClick={handleRawValueChange('isPaywall')}>
            <ButtonMenuItem >{t("CanCan")}</ButtonMenuItem>
            <ButtonMenuItem >{t("Subscription")}</ButtonMenuItem>
      ...
      <Box>
        <Text small color="textSubtle">
          {t('The will execute the purchase of the listed item in the specified markeplace. Please read the documentation for more information on each parameter')}
        </Text>
      </Box>
    </Grid>
      <Divider />
