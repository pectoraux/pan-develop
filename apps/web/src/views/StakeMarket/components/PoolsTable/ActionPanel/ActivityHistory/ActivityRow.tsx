            ...
            {!nft ? (
              ...
              <>
                <Box width={64} height={64} mr={[0, null, '16px']} mb={['8px', null, 0]}>
                  <NextLinkFromReactRouter to={`${cancanBaseUrl}/collections/${nft.collection?.id}/${tokenId}`}>
                ...
                <Flex flexDirection="column">
                  <Text
                    ...
                    to={`${cancanBaseUrl}/collections/${nft.collection?.id}`}
                  ...
                  <Text
                    as={NextLinkFromReactRouter}
                    to={`${cancanBaseUrl}/collections/${nft.collection?.id}/${tokenId}`}
                    textAlign={['center', null, 'left']}
                    bold
                  >
                    {tokenId}
