...
import { Activity, Collection, NftToken } from 'state/cancan/types'
...
import { Arrow, PageButtons } from 'views/CanCan/market/components/PaginationButtons'
import NoNftsImage from 'views/CanCan/market/components/Activity/NoNftsImage'
