...
const PoolRow: React.FC<any> = ({
  ...
  return (
    ...
    >
      <NameCell pool={pool} />
      <TotalUsersCell pool={pool} account={account} labelText={t("Total Users")} />
      <TotalValueCell labelText={t('End Amount')} pool={pool} />
      <EndsInCell labelText={t('Start Time')} value={pool?.startTime} />
      <EndsInCell labelText={t('End Time')} value={pool?.endTime} />
    </ExpandRow>
  )
}
