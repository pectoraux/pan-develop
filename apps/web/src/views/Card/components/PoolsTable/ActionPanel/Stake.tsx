...
const Staked: React.FunctionComponent<any> = ({ pool, currAccount }) => {
  ...
  const cardCurrencyInput = useCurrency(currencyId)
  const [currency, setCurrency] = useState(cardCurrencyInput)
  ...
  return (
    <ActionContainer>
      ...
      <CurrencyInputPanel
        showInput={false}
        currency={currency ?? cardCurrencyInput}
        onCurrencySelect={handleInputSelect}
        otherCurrency={currency ?? cardCurrencyInput}
        id={pool?.sousId}
      />
      <ActionContent>
        <Button
