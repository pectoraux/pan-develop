...
const Pools: React.FC<any> = () => {
  ...
  const [onPresentAdminSettings] = useModal(<CreateGaugeModal variant='admin' location='fromBill' currency={currency} pool={ogBill} />,)
          ...
          {({ chosenPools, viewMode, stakedOnly, normalizedUrlSearch }) => (
            <>
              ...
              {viewMode === ViewMode.CARD ? (
                ...
                <PoolsTable urlSearch={normalizedUrlSearch} ogBill={ogBill} pools={chosenPools} account={account} />
              )}
              <Image
                mx="auto"
                mt="12px"
