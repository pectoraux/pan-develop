...
const Staked: React.FunctionComponent<any> = ({ pool, currAccount }) => {
  ...
  const billCurrencyInput = useCurrency(currencyId)
  const [currency, setCurrency] = useState(billCurrencyInput)
  ...
  return (
    <ActionContainer>
      ...
      <CurrencyInputPanel
        showInput={false}
        currency={currency ?? billCurrencyInput}
        onCurrencySelect={handleInputSelect}
        otherCurrency={currency ?? billCurrencyInput}
        id={pool?.sousId}
      />
      <ActionContent>
        <Button
