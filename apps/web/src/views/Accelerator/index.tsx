...
const Pools: React.FC<any> = () => {
  ...
  const [onPresentCreate] = useModal(<CreateAcceleratorModal currency={currency} />)
        ...
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            <Heading as="h1" scale="xxl" color="secondary" mb="24px">
              {isBounties ? t('Trust Bounties') : t('Accelerator')}
            </Heading>
            <Heading scale="md" color="text">
              {isBounties ? t('Have a business listed ?') : t('Publish a pitch describing your company and team.')}
            </Heading>
            <Heading scale="md" color="text">
              {isBounties ? t('Create a trust bounty to grow trust with your customers') : t('Receive votes to be elligible for a portion of the weekly emissions.')}
            </Heading>
            <Flex>
