...
const Pools: React.FC<any> = () => {
  ...
  const [onPresentCreate] = useModal(<CreateBusinessModal />)
        ...
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            <Heading as="h1" scale="xxl" color="secondary" mb="24px">
              {isBounties ? t('Trust Bounties') : t('CanCan Businesses')}
            </Heading>
            <Heading scale="md" color="text">
              {isBounties ? t('Have a business listed ?') : t('Have a business in the marketplace?')}
            </Heading>
            <Heading scale="md" color="text">
              {isBounties ? t('Create a trust bounty to grow trust with your customers') : t('Create a gauge and start earning each time you make a sale.')}
            </Heading>
            <Flex>
