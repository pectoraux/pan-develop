...
const useFarmsWithBalance = () => {
  ...
  const proxyAddress = AddressZero
...
function getFarmsWithBalances(farmsWithProxy: any, proxyAddress: string, bCakeProxy: BCakeProxy) {
  throw new Error('Function not implemented.')
}

function splitProxyFarms(farmsCanFetch: SerializedFarmConfig[]): { farmsWithProxy: any } {
  throw new Error('Function not implemented.')
}
