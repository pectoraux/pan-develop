...
import { Box, Flex, HelpIcon, Text, useTooltip, useMatchBreakpoints, Pool } from '@pancakeswap/uikit'
    ...
    <StyledActionPanel expanded={expanded}>
      <InfoSection>
        <Flex flexDirection="column" mb="8px">
          <PoolStatsInfo pool={pool} account={account} currAccount={currAccount} showTotalStaked={isMobile} alignLinksToRight={isMobile} />
        </Flex>
      </InfoSection>
      <ActionContainer>
        <Box width="100%">
