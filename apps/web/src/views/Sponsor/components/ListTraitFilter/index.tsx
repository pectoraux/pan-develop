...
export const ListTraitFilter: React.FC<any> = ({ title, nftFilters, traitType, items, setNewFilters }) => {
  ...
  const traitFilter = nftFilters && nftFilters[traitType]
  ...
  const handleItemSelect = ({ attr }: Item) => {
    const newFilters = { ...nftFilters, [traitType]: nftFilters[traitType] ? [...nftFilters[traitType], attr.value] : [attr.value]}
    setNewFilters(newFilters)
  }
  ...
  return (
    <Flex flexDirection="column" justifyContent="center" alignItems="center">
      <Flex justifyContent="center" alignItems="center" mr="4px" mb="4px">
          <TriggerButton
