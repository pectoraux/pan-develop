    ...
    <>
      <Box p="16px" maxWidth="360px">
        ...
        <Text mt="24px" color="textSubtle">
          {t('Resetting cashback limits for this product will erase any record of previous rewards such that users who already got a cashback will become elligible again.')}
        </Text>
