  ...
  return (
    <>
      ...
      <GreyedOutContainer>
        ...
        <StyledItemRow>
          <ButtonMenu scale="xs" variant='subtle' activeIndex={state.isTradable ? 1 : 0} onItemClick={handleRawValueChange('isTradable')}>
