...
const LockedModalBody: React.FC<any> = ({
  ...
  return (
    <>
      <Box mb="16px">
        {editAmountOnly}
        {checkedState ? <LockDurationField identityTokenId={identityTokenId} setIdentityTokenId={setIdentityTokenId} isOverMax={isOverMax} setDuration={setDuration} duration={duration} /> : null}
      </Box>
      {customOverview ? (
        customOverview({
          isValidDuration,
