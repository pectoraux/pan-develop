...
const SetPriceStage: React.FC<any> = ({
  ...
  return (
    ...
    <GreyedOutContainer style={{ paddingTop:"50px" }}>
        ...
        <ButtonMenu scale="xs" variant='subtle' activeIndex={state.automatic} onItemClick={handleRawValueChange('automatic')}>
    ...
    <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
      ...
      <Box>
        <Text small color="textSubtle">
          {t('The will update parameters of the ramp. Please read the documentation for more information on each parameter')}
        </Text>
      </Box>
    </Grid>
      <Divider />
