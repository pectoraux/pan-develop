...
import { getCollection, getPaywallSg } from 'state/cancan/helpers'
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    props: {
      fallback: {
        [unstable_serialize(['paywall', collectionAddress, tokenId])]: nft,
        ...(collection && {
          [unstable_serialize(['cancan', 'collections', collectionAddress])]: collection,
        }),
      },
    },
